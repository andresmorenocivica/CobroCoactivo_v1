...
public class EtapasTrabajos implements java.io.Serializable {
    ...
    public EtapasTrabajos(CivEtapasTrabajos civEtapasTrabajos) {
        ...
        this.obligatorio = civEtapasTrabajos.getEtatraObligatorio();
        this.prioridad = civEtapasTrabajos.getEtatraPrioridad().intValue();
    }
