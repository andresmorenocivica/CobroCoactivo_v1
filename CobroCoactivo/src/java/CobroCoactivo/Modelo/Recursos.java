...
public class Recursos implements java.io.Serializable {
    ...
    public Recursos(CivRecursos civRecursos) {
        this.recId = civRecursos.getRecId();
        this.recNombre = civRecursos.getRecNombre();
        this.recDescripcion = civRecursos.getRecDescripcion();
        this.recCarperta = civRecursos.getRecCarperta();
        this.recFechaproceso = civRecursos.getRecFechaproceso();
    }
