 ...
 * @author emadridp
 */
public class ExpedientesException extends Exception {

    private int nivel;

    /**
     * Creates a new instance of <code>ExpedientesException</code> without
     * detail message.
     */
    public ExpedientesException() {
    }

    /**
     * Constructs an instance of <code>ExpedientesException</code> with the
     * specified detail message.
     *
     * @param message
     * @param nivel
     */
    public ExpedientesException(String message, int nivel) {
        super(message);
        this.nivel = nivel;
    }
