 ...
 * @author emadridp
 */
public class DeudasException extends Exception {

    private int nivel;

    /**
     * Creates a new instance of <code>DeudasException</code> without detail
     * message.
     */
    public DeudasException() {
    }

    /**
     * Constructs an instance of <code>DeudasException</code> with the specified
     * detail message.
     *
     * @param message
     * @param nivel
     */
    public DeudasException(String message, int nivel) {
        super(message);
        this.nivel = nivel;
    }
