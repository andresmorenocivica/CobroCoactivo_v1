 ...
 * @author emadridp
 */
public class PlanGeneralExcepcion extends Exception {

    private int nivel;

    /**
     * Creates a new instance of <code>PlanGeneralExcepcion</code> without
     * detail message.
     */
    public PlanGeneralExcepcion() {
    }

    /**
     * Constructs an instance of <code>PlanGeneralExcepcion</code> with the
     * specified detail message.
     *
     * @param message
     * @param nivel
     */
    public PlanGeneralExcepcion(String message, int nivel) {
        super(message);
        this.nivel = nivel;
