 ...
 * @author emadridp
 */
public class PlanTrabajoException extends Exception {

    private int nivel;

    /**
     * Creates a new instance of <code>PlanTrabajoException</code> without
     * detail message.
     */
    public PlanTrabajoException() {
    }

    /**
     * Constructs an instance of <code>PlanTrabajoException</code> with the
     * specified detail message.
     *
     * @param message
     * @param nivel
     */
    public PlanTrabajoException(String message, int nivel) {
        super(message);
        this.nivel = nivel;
    }
