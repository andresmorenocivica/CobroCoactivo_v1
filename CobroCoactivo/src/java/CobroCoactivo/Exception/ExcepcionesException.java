 ...
 * @author emadridp
 */
public class ExcepcionesException extends Exception {

    private int nivel;

    /**
     * Creates a new instance of <code>ExcepcionesException</code> without
     * detail message.
     */
    public ExcepcionesException() {
    }

    /**
     * Constructs an instance of <code>ExcepcionesException</code> with the
     * specified detail message.
     *
     * @param message
     * @param nivel
     */
    public ExcepcionesException(String message, int nivel) {
        super(message);
        this.nivel = nivel;
    }
