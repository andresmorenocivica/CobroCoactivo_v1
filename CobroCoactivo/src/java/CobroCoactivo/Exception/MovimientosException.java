...
public class MovimientosException extends Exception {
    ...
    /**
     * Creates a new instance of <code>MovimientosException</code> without
     * detail message.
     */
    ...
    /**
     * Constructs an instance of <code>MovimientosException</code> with the
     * specified detail message.
     *
     * @param message
     * @param nivel
     */
    public MovimientosException(String message, int nivel) {
        super(message);
        this.nivel = nivel;
    }
