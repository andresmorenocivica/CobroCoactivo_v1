...
public class CivMovimientos implements java.io.Serializable {
    ...
    public CivMovimientos(BigDecimal movId, CivUsuarios civUsuarios, CivPersonas civPersonas, CivFasesTrabajos civFasesTrabajos, CivEstadoMovimientos civEstadoMovimientos, CivDeudas civDeudas, Date movFechaproceso, Set civExcepcioneses) {
        this.movId = movId;
        this.civUsuarios = civUsuarios;
        this.civPersonas = civPersonas;
        this.civFasesTrabajos = civFasesTrabajos;
